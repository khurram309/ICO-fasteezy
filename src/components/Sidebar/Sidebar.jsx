    ...
    <div className="sidebar px-sm-2 px-0 bg-gray90">
      <div className="d-flex flex-column align-items-center justify-content-between px-2 pt-2 text-white h-100">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.33 19.83">
                <g id="Layer_2" data-name="Layer 2">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <path class="cls-1" d="M9.33,19.83v-7H14v7h5.83V10.5h3.5L11.67,0,0,10.5H3.5v9.33Z"/>
                  </g>
                </g>
              </svg>
          ...
          <li className="nav-item">
            <a href="#" className="nav-link align-middle px-0 d-flex align-items-center gap-2 flex-column fs-small fc-darkPrimary">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 27">
                <g id="Layer_2" data-name="Layer 2">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <path class="cls-1" d="M24,0H3A3,3,0,0,0,0,3V24a3,3,0,0,0,3,3H24a3,3,0,0,0,3-3V3A3,3,0,0,0,24,0ZM9,21H6V10.5H9Zm6,0H12V6h3Zm6,0H18V15h3Z"/>
                  </g>
                </g>
              </svg>
          ...
          <li className="nav-item">
            <a href="#" className="nav-link align-middle px-0 d-flex align-items-center gap-2 flex-column fs-small fc-darkPrimary">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 35.94 36">
                <g id="Layer_2" data-name="Layer 2">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <path class="cls-1" d="M18,20.25A10.13,10.13,0,1,0,7.88,10.12,10.13,10.13,0,0,0,18,20.25Zm6.69,2.25H11.25A11.25,11.25,0,0,0,0,33.75,2.24,2.24,0,0,0,2.19,36H33.75a2.2,2.2,0,0,0,2.19-2.25A11.17,11.17,0,0,0,24.69,22.5Z"/>
                  </g>
                </g>
              </svg>
        ...
        <div className="dropdown text-uppercase w-100">
          <a href="#" className="nav-link align-middle px-0 d-flex align-items-center gap-2 flex-column fs-small fc-darkPrimary" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27.5 24.75">
              <g id="Layer_2" data-name="Layer 2">
                <g id="Layer_1-2" data-name="Layer 1">
                  <path class="cls-1" d="M20.63,5.5,18.69,7.44,22.23,11h-14v2.75h14L18.69,17.3l1.94,1.95,6.87-6.87ZM2.75,2.75h11V0h-11A2.76,2.76,0,0,0,0,2.75V22a2.76,2.76,0,0,0,2.75,2.75h11V22h-11Z"/>
                </g>
              </g>
            </svg>
