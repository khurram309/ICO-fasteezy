    ...
    <>
      <Container className='pt-9'>
        <Row className='howItWork-wrapper bg-white'>
          <Col xs={12} md={6} className='signUp-screen'>
              ...
              <Row className='align-items-center fc-primary'>
                <Col xs={3}>
                  ...
                  >
                    ...
                    <p className='m-0 lh-normal w-80'>Speed & Simplicity</p>
                  </Stack>
                </Col>
                <Col xs={5}>
                  <Stack
                  ...
                  >
                    ...
                    <p className='m-0 lh-normal w-80'>Customer Retention & Expansion</p>
                  </Stack>
                </Col>
                <Col xs={4}>
                  <Stack
                  ...
                  >
                    ...
                    <p className='m-0 lh-normal w-80'>Easy to Track Results</p>
                  </Stack>
                </Col>
              </Row>
            </div>
