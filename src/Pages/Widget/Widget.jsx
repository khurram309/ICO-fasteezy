    ...
    <div className="widget-wrapper p-2 p-sm-4">
      ...
      <div className="row mt-5">
        <div className="col-12">
          ...
          <div className="row share-widgets">
            <div className="col-5 col-sm-2">
              <Link className="card-shadow singleWidget d-flex flex-column align-items-center p-1 p-md-4 fc-darkPrimary justify-content-center gap-2 active">
                <h4>Widget Link</h4>
            ...
            <div className="col-5 col-sm-2">
              <Link className="card-shadow singleWidget social-media d-flex flex-column align-items-center p-1 p-md-4 fc-darkPrimary justify-content-center gap-2">
                <h4>Social Media</h4>
            ...
            <div className="col-5 col-sm-2">
              <Link className="card-shadow singleWidget d-flex flex-column align-items-center p-1 p-md-4 fc-darkPrimary justify-content-center gap-2">
                <h4>QR Code</h4>
            ...
            <div className="col-5 col-sm-2">
              <Link className="card-shadow singleWidget d-flex flex-column align-items-center p-1 p-md-3 fc-darkPrimary justify-content-center gap-2">
