  ...
  return (
    <div className="funds-wrapper p-4">
                ...
                <Form>
                  ...
                  <ul className='list-unstyled filed-cards mt-3'>
                    <li className='d-flex align-items-center gap-2'>
                      <svg enableBackground="new 0 0 780 500" height="500" viewBox="0 0 780 500" width="780" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="card-shadow d-flex align-items-center gap-3 p-3 px-4">
        <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 27 27" width="40" height="27" fill="none">
