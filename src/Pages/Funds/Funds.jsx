...
function Funds() {
  return (
    <div className="funds-wrapper p-4">
      <div className="upper-wrapper d-flex">
        ...
        <div className="balance-section d-flex flex-column align-items-center">
      ...
      <div className="card-shadow d-flex align-items-center gap-3 p-3 px-4">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 27 27" width="27" height="27" fill="none">
